...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
    ...
    */
     ...
     *                               True - Return rows and columns indexed by their actual row and column IDs
     * 
     * mstarproject::vladimir.fedorov add parameter $fromCell
     * 
     * @return array
     */
	public function toArray($nullValue = null, $calculateFormulas = true, $formatData = true, $returnCellRef = false, $fromCell = 'A1') {
        // Garbage collect...
        $this->garbageCollect();
        ...
        // Return
		return $this->rangeToArray(	$fromCell.':'.$maxCol.$maxRow,
									$nullValue, $calculateFormulas, $formatData, $returnCellRef);
    }
